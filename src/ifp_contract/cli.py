...
def _parser() -> argparse.ArgumentParser:
    ...
    anchor.add_argument("--eid", help="Question, Button or Rule eid; automatically locate its file and entry")
    ...
    trace.add_argument("--output", type=Path, help="report directory (default: ./trace-output, with a suffix if it exists)")
